  ...
  describe "mocking a routes response" do
    context "by default" do
      it "writes the fixture" do
        mock(File).open.with_any_args do |*args|
          args[0].should == "test_dir/fixtures/200_links_id.fixture"
          args[1].should == "w"
      ...
      it "generates the fixture path" do
        mock(File).open.with_any_args
        mock_route.respond_with(200, "CONTENT")
        mock_route.response[200]['fixture_path'].should == "test_dir/fixtures/200_links_id.fixture"
      end
    ...
    context "with options" do
      ...
      it "accepts a default option" do
        ...
        mock_route.response['default']['fixture_path'].should == "test_dir/fixtures/200_links_id.fixture"
      end
    end
  end
end
